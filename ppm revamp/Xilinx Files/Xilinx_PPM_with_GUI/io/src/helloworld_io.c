...
// Points for each player in the previous turn (used for testing if someone won)
u8 PREV_P1PT = 0;
u8 PREV_P2PT = 0;
...
void decode_and_print(void){
	...
	// P1 wins if their was points overflow past 255 / 0xFF
	if (P1PT < PREV_P1PT)
		P1_WIN = 1;
	// P2 wins if there was points overflow past 255 / 0xFF
	else if (P2PT < PREV_P2PT)
		P2_WIN = 1;
	// Update points values if nobody won yet
	else {
		PREV_P1PT = P1PT;
		PREV_P2PT = P2PT;
	}
	...
	xil_printf("rd0:%x,rd1:%x,rd2:%x,", RD, NEXT1_RD, NEXT2_RD);
	...
	xil_printf("p1played:%d,p1sel:%d,p1skip:%d,", P1PLAYED_READ, P1SEL_READ, P1SKIP_READ);
	xil_printf("p2played:%d,p2sel:%d,p2skip:%d,", P2PLAYED_READ, P2SEL_READ, P2SKIP_READ);
	xil_printf("P1_WIN:%d,P2_WIN:%d,", P1_WIN, P2_WIN);
	xil_printf("\r\n");
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////
	//////////////////////////////////////// DATA PRINTED ///////////////////////////////////////////////////////
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////
