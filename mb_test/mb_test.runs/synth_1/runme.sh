...
HD_PWD='C:/Users/acb610/Documents/GitHub/CS2204-Summer-2016-Research-Project/mb_test/mb_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source mb_wrapper.tcl
