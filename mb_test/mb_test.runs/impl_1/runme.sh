...
HD_PWD='C:/Users/acb610/Documents/GitHub/CS2204-Summer-2016-Research-Project/mb_test/mb_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source mb_wrapper.tcl -notrace
