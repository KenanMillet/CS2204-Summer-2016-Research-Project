...
<drawing version="7">
    ...
    <netlist>
        ...
        <signal name="XLXN_48" />
        <signal name="recv" />
        <signal name="sendConfirmed" />
        <signal name="recvConfirmed" />
        <signal name="XLXN_52" />
        <signal name="XLXN_53" />
        <signal name="XLXN_54" />
        <signal name="send" />
        ...
        <port polarity="Input" name="recv" />
        <port polarity="Input" name="sendConfirmed" />
        <port polarity="Output" name="recvConfirmed" />
        <port polarity="Output" name="send" />
        <blockdef name="Gomoku_ControlUnit_V">
            <timestamp>2016-7-23T18:53:45</timestamp>
        ...
        <blockdef name="Gomoku_IO_V">
            <timestamp>2016-7-22T17:33:28</timestamp>
            <rect width="416" x="64" y="-696" height="696" />
            <line x2="0" y1="-416" y2="-416" x1="64" />
            <line x2="0" y1="-352" y2="-352" x1="64" />
            <line x2="0" y1="-288" y2="-288" x1="64" />
        ...
        <block symbolname="Gomoku_ControlUnit_V" name="XLXI_9">
            ...
            <blockpin signalname="XLXN_54" name="start" />
            <blockpin signalname="XLXN_8" name="valid" />
            <blockpin signalname="XLXN_13" name="check" />
            <blockpin signalname="XLXN_5" name="p2sturn" />
            <blockpin signalname="XLXN_52" name="p1sturn" />
            <blockpin signalname="XLXN_53" name="confirm" />
        ...
        <block symbolname="Gomoku_PlayCheck_V" name="XLXI_12">
            ...
            <blockpin signalname="XLXN_8" name="valid" />
            <blockpin signalname="XLXN_56" name="win" />
        </block>
        ...
        <block symbolname="Gomoku_IO_V" name="XLXI_28">
            ...
            <blockpin signalname="playerOut" name="USBp1sturn" />
            <blockpin signalname="XLXN_46" name="p2canplay" />
            <blockpin signalname="XLXN_47" name="p1played" />
            <blockpin signalname="send" name="sendOut" />
            <blockpin signalname="sendConfirmed" name="sendConfirmedIn" />
            <blockpin signalname="recvConfirmed" name="recvConfirmedOut" />
            <blockpin signalname="XLXN_52" name="p1sturn" />
            <blockpin signalname="XLXN_53" name="sendIn" />
            <blockpin signalname="recv" name="recvIn" />
            <blockpin signalname="XLXN_54" name="recvOut" />
        </block>
        <block symbolname="or2" name="XLXI_30">
            <blockpin signalname="winIn" name="I0" />
            <blockpin signalname="XLXN_56" name="I1" />
            <blockpin signalname="winOut" name="O" />
        </block>
    ...
    <sheet sheetnum="1" width="3520" height="2720">
        ...
        <branch name="playerOut">
            ...
            <wire x2="3312" y1="640" y2="640" x1="2672" />
        </branch>
        ...
        <branch name="XLXN_35(3:0)">
            ...
            <wire x2="2784" y1="480" y2="480" x1="2592" />
        ...
        <branch name="XLXN_36(3:0)">
            ...
            <wire x2="2752" y1="544" y2="544" x1="2592" />
        ...
        <iomarker fontsize="28" x="3312" y="928" name="send" orien="R0" />
        <instance x="2048" y="1024" name="XLXI_28" orien="R0">
        </instance>
        <branch name="sendConfirmed">
            <wire x2="480" y1="160" y2="160" x1="320" />
            <wire x2="1904" y1="96" y2="96" x1="480" />
            <wire x2="1904" y1="96" y2="416" x1="1904" />
            <wire x2="2048" y1="416" y2="416" x1="1904" />
            <wire x2="480" y1="96" y2="160" x1="480" />
        </branch>
        <iomarker fontsize="28" x="320" y="160" name="sendConfirmed" orien="R180" />
        <branch name="recvConfirmed">
            <wire x2="2960" y1="416" y2="416" x1="2592" />
            <wire x2="3312" y1="320" y2="320" x1="2960" />
            <wire x2="2960" y1="320" y2="416" x1="2960" />
        </branch>
        <iomarker fontsize="28" x="3312" y="320" name="recvConfirmed" orien="R0" />
        <iomarker fontsize="28" x="320" y="240" name="recv" orien="R180" />
        <branch name="XLXN_52">
            <wire x2="1856" y1="512" y2="512" x1="1680" />
            <wire x2="1856" y1="512" y2="544" x1="1856" />
            <wire x2="2048" y1="544" y2="544" x1="1856" />
        </branch>
        <branch name="XLXN_53">
            <wire x2="1840" y1="576" y2="576" x1="1680" />
            <wire x2="1840" y1="480" y2="576" x1="1840" />
            <wire x2="2048" y1="480" y2="480" x1="1840" />
        </branch>
        <branch name="recv">
            <wire x2="1840" y1="240" y2="240" x1="320" />
            <wire x2="1840" y1="240" y2="352" x1="1840" />
            <wire x2="2048" y1="352" y2="352" x1="1840" />
        </branch>
        <branch name="XLXN_54">
            <wire x2="1264" y1="704" y2="704" x1="1248" />
            <wire x2="1248" y1="704" y2="1040" x1="1248" />
            <wire x2="2704" y1="1040" y2="1040" x1="1248" />
            <wire x2="2704" y1="352" y2="352" x1="2592" />
            <wire x2="2704" y1="352" y2="1040" x1="2704" />
        </branch>
        <branch name="send">
        ...
        <branch name="winIn">
            ...
            <wire x2="1776" y1="1520" y2="1520" x1="784" />
            <wire x2="784" y1="1520" y2="1696" x1="784" />
            <wire x2="2016" y1="1248" y2="1248" x1="1776" />
            <wire x2="1776" y1="1248" y2="1520" x1="1776" />
        </branch>
        <instance x="2016" y="1312" name="XLXI_30" orien="R0" />
        <branch name="XLXN_56">
            <wire x2="2016" y1="1184" y2="1184" x1="1696" />
        </branch>
        <branch name="winOut">
            <wire x2="2848" y1="1216" y2="1216" x1="2272" />
            <wire x2="2848" y1="1216" y2="1696" x1="2848" />
            <wire x2="3312" y1="1696" y2="1696" x1="2848" />
        </branch>
        <branch name="XLXN_57">
            <wire x2="1264" y1="640" y2="640" x1="1040" />
        </branch>
        <instance x="912" y="576" name="XLXI_33" orien="R90" />
    </sheet>
</drawing>