...
HD_PWD='C:/Users/acb610/Documents/GitHub/CS2204-Summer-2016-Research-Project/microblaze_project/microblaze_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log microblaze_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source microblaze_wrapper.tcl -notrace
