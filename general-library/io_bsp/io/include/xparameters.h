...
#define XPAR_IO_SCO 0
#define XPAR_IO_FREQ 100000000
#define XPAR_IO_DATA_SIZE 32
#define XPAR_IO_DYNAMIC_BUS_SIZING 1
#define XPAR_IO_AVOID_PRIMITIVES 0
#define XPAR_IO_FAULT_TOLERANT 0
#define XPAR_IO_ECC_USE_CE_EXCEPTION 0
#define XPAR_IO_LOCKSTEP_SLAVE 0
#define XPAR_IO_ENDIANNESS 1
#define XPAR_IO_AREA_OPTIMIZED 1
#define XPAR_IO_OPTIMIZATION 0
#define XPAR_IO_INTERCONNECT 2
#define XPAR_IO_STREAM_INTERCONNECT 0
#define XPAR_IO_DPLB_DWIDTH 32
#define XPAR_IO_DPLB_NATIVE_DWIDTH 32
#define XPAR_IO_DPLB_BURST_EN 0
#define XPAR_IO_DPLB_P2P 0
#define XPAR_IO_IPLB_DWIDTH 32
#define XPAR_IO_IPLB_NATIVE_DWIDTH 32
#define XPAR_IO_IPLB_BURST_EN 0
#define XPAR_IO_IPLB_P2P 0
#define XPAR_IO_M_AXI_DP_SUPPORTS_THREADS 0
#define XPAR_IO_M_AXI_DP_THREAD_ID_WIDTH 1
#define XPAR_IO_M_AXI_DP_SUPPORTS_READ 1
#define XPAR_IO_M_AXI_DP_SUPPORTS_WRITE 1
#define XPAR_IO_M_AXI_DP_SUPPORTS_NARROW_BURST 0
#define XPAR_IO_M_AXI_DP_DATA_WIDTH 32
#define XPAR_IO_M_AXI_DP_ADDR_WIDTH 32
#define XPAR_IO_M_AXI_DP_PROTOCOL AXI4LITE
#define XPAR_IO_M_AXI_DP_EXCLUSIVE_ACCESS 0
#define XPAR_IO_INTERCONNECT_M_AXI_DP_READ_ISSUING 1
#define XPAR_IO_INTERCONNECT_M_AXI_DP_WRITE_ISSUING 1
#define XPAR_IO_M_AXI_IP_SUPPORTS_THREADS 0
#define XPAR_IO_M_AXI_IP_THREAD_ID_WIDTH 1
#define XPAR_IO_M_AXI_IP_SUPPORTS_READ 1
#define XPAR_IO_M_AXI_IP_SUPPORTS_WRITE 0
#define XPAR_IO_M_AXI_IP_SUPPORTS_NARROW_BURST 0
#define XPAR_IO_M_AXI_IP_DATA_WIDTH 32
#define XPAR_IO_M_AXI_IP_ADDR_WIDTH 32
#define XPAR_IO_M_AXI_IP_PROTOCOL AXI4LITE
#define XPAR_IO_INTERCONNECT_M_AXI_IP_READ_ISSUING 1
#define XPAR_IO_D_AXI 0
#define XPAR_IO_D_PLB 0
#define XPAR_IO_D_LMB 1
#define XPAR_IO_I_AXI 0
#define XPAR_IO_I_PLB 0
#define XPAR_IO_I_LMB 1
#define XPAR_IO_USE_MSR_INSTR 0
#define XPAR_IO_USE_PCMP_INSTR 0
#define XPAR_IO_USE_BARREL 0
#define XPAR_IO_USE_DIV 0
#define XPAR_IO_USE_HW_MUL 0
#define XPAR_IO_USE_FPU 0
#define XPAR_IO_USE_REORDER_INSTR 0
#define XPAR_IO_UNALIGNED_EXCEPTIONS 0
#define XPAR_IO_ILL_OPCODE_EXCEPTION 0
#define XPAR_IO_M_AXI_I_BUS_EXCEPTION 0
#define XPAR_IO_M_AXI_D_BUS_EXCEPTION 0
#define XPAR_IO_IPLB_BUS_EXCEPTION 0
#define XPAR_IO_DPLB_BUS_EXCEPTION 0
#define XPAR_IO_DIV_ZERO_EXCEPTION 0
#define XPAR_IO_FPU_EXCEPTION 0
#define XPAR_IO_FSL_EXCEPTION 0
#define XPAR_IO_USE_STACK_PROTECTION 0
#define XPAR_IO_PVR 0
#define XPAR_IO_PVR_USER1 0x00
#define XPAR_IO_PVR_USER2 0x00000000
#define XPAR_IO_DEBUG_ENABLED 0
#define XPAR_IO_NUMBER_OF_PC_BRK 1
#define XPAR_IO_NUMBER_OF_RD_ADDR_BRK 0
#define XPAR_IO_NUMBER_OF_WR_ADDR_BRK 0
#define XPAR_IO_INTERRUPT_IS_EDGE 0
#define XPAR_IO_EDGE_IS_POSITIVE 1
#define XPAR_IO_RESET_MSR 0x00000000
#define XPAR_IO_OPCODE_0X0_ILLEGAL 0
#define XPAR_IO_FSL_LINKS 0
#define XPAR_IO_FSL_DATA_SIZE 32
#define XPAR_IO_USE_EXTENDED_FSL_INSTR 0
#define XPAR_IO_M0_AXIS_PROTOCOL GENERIC
#define XPAR_IO_S0_AXIS_PROTOCOL GENERIC
#define XPAR_IO_M1_AXIS_PROTOCOL GENERIC
#define XPAR_IO_S1_AXIS_PROTOCOL GENERIC
#define XPAR_IO_M2_AXIS_PROTOCOL GENERIC
#define XPAR_IO_S2_AXIS_PROTOCOL GENERIC
#define XPAR_IO_M3_AXIS_PROTOCOL GENERIC
#define XPAR_IO_S3_AXIS_PROTOCOL GENERIC
#define XPAR_IO_M4_AXIS_PROTOCOL GENERIC
#define XPAR_IO_S4_AXIS_PROTOCOL GENERIC
#define XPAR_IO_M5_AXIS_PROTOCOL GENERIC
#define XPAR_IO_S5_AXIS_PROTOCOL GENERIC
#define XPAR_IO_M6_AXIS_PROTOCOL GENERIC
#define XPAR_IO_S6_AXIS_PROTOCOL GENERIC
#define XPAR_IO_M7_AXIS_PROTOCOL GENERIC
#define XPAR_IO_S7_AXIS_PROTOCOL GENERIC
#define XPAR_IO_M8_AXIS_PROTOCOL GENERIC
#define XPAR_IO_S8_AXIS_PROTOCOL GENERIC
#define XPAR_IO_M9_AXIS_PROTOCOL GENERIC
#define XPAR_IO_S9_AXIS_PROTOCOL GENERIC
#define XPAR_IO_M10_AXIS_PROTOCOL GENERIC
#define XPAR_IO_S10_AXIS_PROTOCOL GENERIC
#define XPAR_IO_M11_AXIS_PROTOCOL GENERIC
#define XPAR_IO_S11_AXIS_PROTOCOL GENERIC
#define XPAR_IO_M12_AXIS_PROTOCOL GENERIC
#define XPAR_IO_S12_AXIS_PROTOCOL GENERIC
#define XPAR_IO_M13_AXIS_PROTOCOL GENERIC
#define XPAR_IO_S13_AXIS_PROTOCOL GENERIC
#define XPAR_IO_M14_AXIS_PROTOCOL GENERIC
#define XPAR_IO_S14_AXIS_PROTOCOL GENERIC
#define XPAR_IO_M15_AXIS_PROTOCOL GENERIC
#define XPAR_IO_S15_AXIS_PROTOCOL GENERIC
#define XPAR_IO_M0_AXIS_DATA_WIDTH 32
#define XPAR_IO_S0_AXIS_DATA_WIDTH 32
#define XPAR_IO_M1_AXIS_DATA_WIDTH 32
#define XPAR_IO_S1_AXIS_DATA_WIDTH 32
#define XPAR_IO_M2_AXIS_DATA_WIDTH 32
#define XPAR_IO_S2_AXIS_DATA_WIDTH 32
#define XPAR_IO_M3_AXIS_DATA_WIDTH 32
#define XPAR_IO_S3_AXIS_DATA_WIDTH 32
#define XPAR_IO_M4_AXIS_DATA_WIDTH 32
#define XPAR_IO_S4_AXIS_DATA_WIDTH 32
#define XPAR_IO_M5_AXIS_DATA_WIDTH 32
#define XPAR_IO_S5_AXIS_DATA_WIDTH 32
#define XPAR_IO_M6_AXIS_DATA_WIDTH 32
#define XPAR_IO_S6_AXIS_DATA_WIDTH 32
#define XPAR_IO_M7_AXIS_DATA_WIDTH 32
#define XPAR_IO_S7_AXIS_DATA_WIDTH 32
#define XPAR_IO_M8_AXIS_DATA_WIDTH 32
#define XPAR_IO_S8_AXIS_DATA_WIDTH 32
#define XPAR_IO_M9_AXIS_DATA_WIDTH 32
#define XPAR_IO_S9_AXIS_DATA_WIDTH 32
#define XPAR_IO_M10_AXIS_DATA_WIDTH 32
#define XPAR_IO_S10_AXIS_DATA_WIDTH 32
#define XPAR_IO_M11_AXIS_DATA_WIDTH 32
#define XPAR_IO_S11_AXIS_DATA_WIDTH 32
#define XPAR_IO_M12_AXIS_DATA_WIDTH 32
#define XPAR_IO_S12_AXIS_DATA_WIDTH 32
#define XPAR_IO_M13_AXIS_DATA_WIDTH 32
#define XPAR_IO_S13_AXIS_DATA_WIDTH 32
#define XPAR_IO_M14_AXIS_DATA_WIDTH 32
#define XPAR_IO_S14_AXIS_DATA_WIDTH 32
#define XPAR_IO_M15_AXIS_DATA_WIDTH 32
#define XPAR_IO_S15_AXIS_DATA_WIDTH 32
#define XPAR_IO_ICACHE_BASEADDR 0x00000000
#define XPAR_IO_ICACHE_HIGHADDR 0x3FFFFFFF
#define XPAR_IO_USE_ICACHE 0
#define XPAR_IO_ALLOW_ICACHE_WR 1
#define XPAR_IO_ADDR_TAG_BITS 0
#define XPAR_IO_CACHE_BYTE_SIZE 65536
#define XPAR_IO_ICACHE_USE_FSL 0
#define XPAR_IO_ICACHE_LINE_LEN 4
#define XPAR_IO_ICACHE_ALWAYS_USED 0
#define XPAR_IO_ICACHE_INTERFACE 0
#define XPAR_IO_ICACHE_VICTIMS 0
#define XPAR_IO_ICACHE_STREAMS 0
#define XPAR_IO_ICACHE_FORCE_TAG_LUTRAM 0
#define XPAR_IO_ICACHE_DATA_WIDTH 0
#define XPAR_IO_M_AXI_IC_SUPPORTS_THREADS 0
#define XPAR_IO_M_AXI_IC_THREAD_ID_WIDTH 1
#define XPAR_IO_M_AXI_IC_SUPPORTS_READ 1
#define XPAR_IO_M_AXI_IC_SUPPORTS_WRITE 0
#define XPAR_IO_M_AXI_IC_SUPPORTS_NARROW_BURST 0
#define XPAR_IO_M_AXI_IC_DATA_WIDTH 32
#define XPAR_IO_M_AXI_IC_ADDR_WIDTH 32
#define XPAR_IO_M_AXI_IC_PROTOCOL AXI4
#define XPAR_IO_M_AXI_IC_USER_VALUE 0b11111
#define XPAR_IO_M_AXI_IC_SUPPORTS_USER_SIGNALS 1
#define XPAR_IO_M_AXI_IC_AWUSER_WIDTH 5
#define XPAR_IO_M_AXI_IC_ARUSER_WIDTH 5
#define XPAR_IO_M_AXI_IC_WUSER_WIDTH 1
#define XPAR_IO_M_AXI_IC_RUSER_WIDTH 1
#define XPAR_IO_M_AXI_IC_BUSER_WIDTH 1
#define XPAR_IO_INTERCONNECT_M_AXI_IC_READ_ISSUING 2
#define XPAR_IO_DCACHE_BASEADDR 0x00000000
#define XPAR_IO_DCACHE_HIGHADDR 0x3FFFFFFF
#define XPAR_IO_USE_DCACHE 0
#define XPAR_IO_ALLOW_DCACHE_WR 1
#define XPAR_IO_DCACHE_ADDR_TAG 0
#define XPAR_IO_DCACHE_BYTE_SIZE 65536
#define XPAR_IO_DCACHE_USE_FSL 0
#define XPAR_IO_DCACHE_LINE_LEN 4
#define XPAR_IO_DCACHE_ALWAYS_USED 0
#define XPAR_IO_DCACHE_INTERFACE 0
#define XPAR_IO_DCACHE_USE_WRITEBACK 0
#define XPAR_IO_DCACHE_VICTIMS 0
#define XPAR_IO_DCACHE_FORCE_TAG_LUTRAM 0
#define XPAR_IO_DCACHE_DATA_WIDTH 0
#define XPAR_IO_M_AXI_DC_SUPPORTS_THREADS 0
#define XPAR_IO_M_AXI_DC_THREAD_ID_WIDTH 1
#define XPAR_IO_M_AXI_DC_SUPPORTS_READ 1
#define XPAR_IO_M_AXI_DC_SUPPORTS_WRITE 1
#define XPAR_IO_M_AXI_DC_SUPPORTS_NARROW_BURST 0
#define XPAR_IO_M_AXI_DC_DATA_WIDTH 32
#define XPAR_IO_M_AXI_DC_ADDR_WIDTH 32
#define XPAR_IO_M_AXI_DC_PROTOCOL AXI4
#define XPAR_IO_M_AXI_DC_EXCLUSIVE_ACCESS 0
#define XPAR_IO_M_AXI_DC_USER_VALUE 0b11111
#define XPAR_IO_M_AXI_DC_SUPPORTS_USER_SIGNALS 1
#define XPAR_IO_M_AXI_DC_AWUSER_WIDTH 5
#define XPAR_IO_M_AXI_DC_ARUSER_WIDTH 5
#define XPAR_IO_M_AXI_DC_WUSER_WIDTH 1
#define XPAR_IO_M_AXI_DC_RUSER_WIDTH 1
#define XPAR_IO_M_AXI_DC_BUSER_WIDTH 1
#define XPAR_IO_INTERCONNECT_M_AXI_DC_READ_ISSUING 2
#define XPAR_IO_INTERCONNECT_M_AXI_DC_WRITE_ISSUING 32
#define XPAR_IO_USE_MMU 0
#define XPAR_IO_MMU_DTLB_SIZE 4
#define XPAR_IO_MMU_ITLB_SIZE 2
#define XPAR_IO_MMU_TLB_ACCESS 3
#define XPAR_IO_MMU_ZONES 16
#define XPAR_IO_MMU_PRIVILEGED_INSTR 0
#define XPAR_IO_USE_INTERRUPT 2
#define XPAR_IO_USE_EXT_BRK 0
#define XPAR_IO_USE_EXT_NM_BRK 0
#define XPAR_IO_USE_BRANCH_TARGET_CACHE 0
#define XPAR_IO_BRANCH_TARGET_CACHE_SIZE 0
#define XPAR_IO_PC_WIDTH 32
