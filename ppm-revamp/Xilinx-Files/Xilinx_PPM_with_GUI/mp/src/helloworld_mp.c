...
u8 RWD;               // gpi 3
u8 NEXT1_RD;
u8 NEXT2_RD;          // Next random digit, code digits ////////////////////// NEW
u8 CODE0;
u8 CODE1;
	...
	if( ((~IO_DATA) & 0x40000000) && ((~MP_DATA) & 0x80000000) ) {
		...
		switch(count) {
			case 0:                                      // DISP(16) and STATE(7) = 23
				...
				data24 |= ((u32)STATE[6]) << 22;
				break;
			case 1:                                      // P1/P2PT(16) and RD(4) and SYSCLK(1), P2CLK(1) = 22
				data24 |=  (u32)P1PT;
				data24 |= ((u32)P2PT)     << 8;
				data24 |= ((u32)RD)       << 16;
				data24 |= ((u32)NEXT1_RD) << 20;
				data24 |= ((u32)NEXT2_RD) << 24;
				data24 |= ((u32)SYSCLK)   << 28;
				data24 |= ((u32)P2CLK)    << 29;
				break;
